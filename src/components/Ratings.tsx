...
const Ratings = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="max-w-[980px] flex flex-col -translate-y-[4.4375rem] mx-auto bg-white rounded-lg p-6 shadow-[0_0_4px_rgba(0,0,0,0.5)]">
        ...
        <div className="w-full flex items-center gap-12">
          ...
          <div className="w-[1px] h-[4.5rem] border-r border-r-[#DBDBDB]" />
        ...
        <p className="font-medium text-sm text-[#666666] pt-5">
          *Reviews imported from Google have not been individually verified by
          HomeAdvisor.
        </p>
      </div>
      <div className="max-w-[980px] flex gap-2 -translate-y-[4.4375rem] mx-auto bg-white rounded-lg">
        <div className="w-[180px] h-[148px] shadow-[0_0_2px_rgba(0,0,0,0.5)] flex flex-col justify-center items-center gap-[.3125rem]">
          <p className="font-bold text-4xl text-textColor">98%</p>
          <p className="font-bold text-lg text-textColor">Recommended</p>
        </div>
        <div className="w-[180px] h-[148px] shadow-[0_0_2px_rgba(0,0,0,0.5)] flex flex-col justify-center items-center gap-[.3125rem]">
          <p className="font-bold text-4xl text-textColor">4</p>
          <p className="font-bold text-lg text-textColor">Years In Business</p>
        </div>
          ...
          <div className="flex justify-between">
            {images.map((image) => (
              <Image
                ...
                height={0}
                sizes="100vw"
                className="w-auto h-[5.125rem]"
              />
            ))}
          </div>
        </div>
      </div>
      <div className="flex justify-center items-center gap-7 bg-white -translate-y-[4.4375rem]">
        {logos.map((logo) => (
          <div key={logo.title} className="flex flex-col items-center gap-5">
            ...
            />
            <p className="max-w-[200px] font-normal text-xl text-[#414141] italic text-center">
              {logo.title}
            </p>
          </div>
        ))}
